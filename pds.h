...
// prints all record in the repository including th deleted ones
void printAllRecords(void (*printer)(void *rec), void *read);

// returns the id of the first non-deleted record
int get_id_first_record(int *id);

// returns the id of the last non-deleted record
